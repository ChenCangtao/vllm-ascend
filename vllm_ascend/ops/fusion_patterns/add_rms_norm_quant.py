...
# If you want to enable this pass, you have two ways.
# 1、 directly import the current file
# 2、 add a __init__.py file to import all fusion passes under a folder by default
